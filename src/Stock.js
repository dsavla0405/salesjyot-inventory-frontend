...
function Stock() {
  ...
  const filteredData = apiData.filter(supplier => {
    return (
      ...
      (supplier.addQty && supplier.addQty.toLowerCase().includes(searchTermAdd.toLowerCase())) &&
      (supplier.subQty && supplier.subQty.toLowerCase().includes(searchTermSub.toLowerCase())) &&
      (searchTermSource === null || searchTermSource === '' || (supplier.source && supplier.source.toLowerCase().includes(searchTermSource.toLowerCase()))) &&
      (searchTermMsg === null || searchTermMsg === '' || (supplier.message && supplier.message.toLowerCase().includes(searchTermMsg.toLowerCase()))) &&
